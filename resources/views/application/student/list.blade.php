                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="">
                                                    ...
                                                    &nbsp;
                                                    <button type="button" onclick="modalAlertDom($(this).parent().find('.trigger-delete'), 'Apakah anda yakin ?' , 'Dengan menghapus siswa ini, maka ia tidak akan dapat mengakses akunnya kembali.')" class="btn-table btn btn-sm btn-danger">
