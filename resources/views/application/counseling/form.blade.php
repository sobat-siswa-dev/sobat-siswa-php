...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    ...
                                    <input name="held_date" required="" value="{{ $behCounseling->held_date }}" type="date" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        Tempat <sup class="font-bold text-red">*</sup>
                                    </label>
                                    <input name="place" required="" value="{{ $behCounseling->place }}" type="text" maxlength="100" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        Permasalahan <sup class="font-bold text-red">*</sup>
                                    </label>
                                    <textarea name="problem" required="" class="form-control" maxlength="255">{{ $behCounseling->problem }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        Solusi <sup class="font-bold text-red">*</sup>
                                    </label>
                                    <textarea name="solution" required="" class="form-control" maxlength="255">{{ $behCounseling->solution }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        {{ $behCounseling->attch ? "Ganti" : "" }} Lampiran
                                    </label>
    ...
    <script>
        $('[name="level"]').val('{{ $behCounseling->level }}');
    </script>
@stop