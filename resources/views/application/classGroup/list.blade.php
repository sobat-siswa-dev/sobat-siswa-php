                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter">
                                ...
                                <tbody>
                                    @foreach ($admClassGroupList as $admClassGroup)
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="">
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="id" value="{{ $admClassGroup->id }}"/>
                                                    ...
                                                    &nbsp;
                                                    <button type="button" onclick="modalAlertDom($(this).parent().find('.trigger-delete'), 'Apakah anda yakin ?' , 'Dengan menghapus grup kelas ini, seluruh kelas yang ada didalamnya akan dikeluarkan dari grup kelas ini.')" class="btn-table btn btn-sm btn-danger">
                                    ...
                                    @endforeach
                                    @if (count($admClassGroupList) == false)
                                        <tr>
                                            <td colspan="4">
                                                <div class="my-3 mt-2">
