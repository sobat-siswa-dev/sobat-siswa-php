@foreach($admStudentList as $admStudent)
    <tr>
        ...
        @if (str_contains($requestUrl, url('attitude/trophy')))
            <td>
                <span style="font-size: .95em; text-decoration: none;">
                    {{ $admStudent->countTrophy() }} Prestasi
                </span>
            </td>
        @elseif (str_contains($requestUrl, url('attitude/violation')))
            <td>
                <span style="font-size: .95em; text-decoration: none;">
                    {{ $admStudent->countViolationPoin() }} Poin
                </span>
            </td>
        @endif
        <td>
