        ...
        <form action="" method="POST">
            ...
            <div class="card card-md">
                <div class="card-body text-center py-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="{{ isset($admSchool) ? url('/login-student/' . $admSchool->code) : url('/login-student') }}" class="btn btn-switcher btn-primary w-100">
                        ...
                        <div class="col">
                            <a href="{{ isset($admSchool) ? url('/login-teacher/' . $admSchool->code) : url('/login-teacher') }}" class="btn btn-switcher btn-white w-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
